export const BridgedFrankencoinABI = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: "getSynchronizeAccountingData",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getSynchronizeAccountingFee",
    outputs: [
      {
        internalType: "uint256",
        name: "",
