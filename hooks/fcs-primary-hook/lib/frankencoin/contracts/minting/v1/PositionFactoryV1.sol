...
import "./PositionV1.sol";
import "./IFrankencoin.sol";

contract PositionFactoryV1 {
    /**
    ...
    function createNewPosition(
        ...
        return address(new PositionV1(_owner, msg.sender, _zchf, _collateral, _minCollateral, _initialLimit, _initPeriod, _duration, _challengePeriod, _annualInterestPPM, _liqPrice, _reserve));
    }
    ...
    function clonePosition(address _existing) external returns (address) {
        PositionV1 existing = PositionV1(_existing);
        PositionV1 clone = PositionV1(_createClone(existing.original()));
