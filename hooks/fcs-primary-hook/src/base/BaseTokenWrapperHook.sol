...
// Local adaptation of v4-hooks-public e4eabe526f9b516fff78d98ba781251747f0fd6e.
// Only functional edits: make _beforeInitialize and _beforeSwap virtual to add
// canonical-pool and mandatory hookData guards. Accounting algorithm unchanged.
// Import of BaseHook redirected to the pinned dependency. See docs/UPSTREAM.md.
...
import {BaseHook} from "v4-hooks/base/BaseHook.sol";
...
abstract contract BaseTokenWrapperHook is BaseHook, DeltaResolver {
    ...
    function _beforeInitialize(address, PoolKey calldata poolKey, uint160) internal view virtual override returns (bytes4) {
